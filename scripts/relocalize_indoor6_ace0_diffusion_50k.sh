...
for seed in ${seeds[*]}; do
  ...
  out_dir="${current_dir}/relocalize/indoor6/ace0_diffusion_50k_seed${seed}"
  ...
  for scene in ${scenes[*]}; do
    ...
    (cd "${ace_zero_path}" && python ${mapping_exe} "${mapping_rgb_files}" \
                                                    ...
                                                    --prior_loss_weight 4000 \
                                                    --prior_diffusion_start_step 5000 \
                                                    --prior_diffusion_warmup_steps 1000 \
                                                    --batch_size 51200 \
                                                    --prior_diffusion_subsample 0.1 \
                                                    --base_seed ${seed})
